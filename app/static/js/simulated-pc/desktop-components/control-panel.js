...
export class ControlPanel {
    ...
    createControlPanel() {
        ...
        this.panelElement.innerHTML = `
            ...
            <button class="control-button w-full bg-gray-700 border border-gray-600 text-white px-3 py-2 mb-2 text-xs text-left hover:bg-gray-600 hover:shadow-lg transition-all duration-200 cursor-pointer rounded" id="help-btn">
                <i class="bi bi-question-circle mr-2"></i> Help
            </button>
            <button class="control-button w-full bg-gray-700 border border-gray-600 text-white px-3 py-2 mb-2 text-xs text-left hover:bg-gray-600 hover:shadow-lg transition-all duration-200 cursor-pointer rounded" id="hint-btn">
                <i class="bi bi-lightbulb mr-2"></i> Hint
            </button>
            <button class="control-button w-full bg-gray-700 border border-gray-600 text-white px-3 py-2 text-xs text-left hover:bg-gray-600 hover:shadow-lg transition-all duration-200 cursor-pointer rounded" id="progress-btn">
    ...
    createHintContent() {
        return `
            <div class="p-5 text-white">
                ...
                <div class="bg-gray-700 rounded p-4 border-l-4 border-yellow-400">
